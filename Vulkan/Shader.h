...
namespace QZL
{
	class Shader {
	public:
		/// Compiles every glsl vertex and fragment shader in /shaders/src/ to SPIR-V.
		/// Postcondition: batch program terminated with success.
		static void runBatchCompilation();
